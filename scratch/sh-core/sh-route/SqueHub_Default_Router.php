<?php 
// sh-core/sh-route/SqueHub_Default_Router.php

/**
 * Default Router Class for SqueHub CMS
 *
 * This class handles routing for the SqueHub CMS, allowing different closure functions to be
 * associated with specific routes. It supports both frontend and admin routes and provides
 * custom 404 handling for each type of route.
 *
 * @package SqueHub
 */
